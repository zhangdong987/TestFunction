...
public class UIVerticalScroller : MonoBehaviour
{
    ...
    private UnityAction<string> ChangeResult;
    ...
    /// </summary>
    public UIVerticalScroller(RectTransform center, RectTransform elementSize, ScrollRect scrollRect, GameObject[] arrayOfElements,UnityAction<string> changeresult=null)
    {
        this.center = center;
